    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-md sm:rounded-lg">
                ...
                <div class="p-6 bg-gradient-to-r from-yellow-500 to-orange-500 text-white">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-yellow-100 text-sm mt-1">Perbarui informasi course:
                                <strong>{{ $course->nama_course }}</strong></p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Form -->
                <form
                    action="{{ Auth::user()->role === 'admin' ? route('courses.update', $course->id) : route('teacher.courses.update', $course->id) }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama_course" id="nama_course"
                                ...
                                class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition @error('nama_course') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="kategori_id" id="kategori_id"
                                class="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition @error('kategori_id') border-red-500 @enderror"
                                required>
                                @foreach ($categories as $cat)
                                    <option value="{{ $cat->id }}"
                                        {{ old('kategori_id', $course->kategori_id) == $cat->id ? 'selected' : '' }}>
                                        {{ $cat->kategori }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="teacher_id" id="teacher_id"
                                    class="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition @error('teacher_id') border-red-500 @enderror"
                                    required>
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4"
                            class="block w-full px-3 py-3 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition @error('deskripsi') border-red-500 @enderror"
                            placeholder="Jelaskan tentang course ini..." required>{{ old('deskripsi', $course->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div
                            class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-yellow-400 transition">
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="gambar"
                                        ...
                                        <span>{{ $course->gambar ? 'Ganti gambar' : 'Upload gambar' }}</span>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" name="tanggal_mulai" id="tanggal_mulai"
                                    value="{{ old('tanggal_mulai', $course->tanggal_mulai) }}"
                                    min="{{ now()->toDateString() }}"
                                    class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition @error('tanggal_mulai') border-red-500 @enderror"
                                    required>
                            </div>
                            @error('tanggal_mulai')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" name="tanggal_selesai" id="tanggal_selesai"
                                    value="{{ old('tanggal_selesai', $course->tanggal_selesai) }}"
                                    class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition @error('tanggal_selesai') border-red-500 @enderror"
                                    required>
                            </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="mt-1 text-sm text-yellow-700">
                                        Course ini memiliki <strong>{{ $course->students->count() }} siswa</strong>
                                        terdaftar. Perubahan akan mempengaruhi semua siswa.
                                    </p>
                                </div>
                            </div>
                        </div>
